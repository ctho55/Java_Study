...
<label for="page">WebPage :</label>
	<select id="page"name="page" size="1">
		...
		<option value="2"> GuGuDan_Servlet</option>
		<option value="3"> Check_Jsp</option>
		<option value="4"> Select_Jsp</option>
	</select><br><br>
	
 	이동방법 :
 	<input type="radio" name="send" id="fo" value="fo" checked>
	<label for="fo">Foward</label>&nbsp;&nbsp;
	<input type="radio" name="send" id="re" value="re">
	<label for="re">Redirect</label><br>
