...
public class Ex01_Math {
	...
	public static void main(String[] args) {
		...
		System.out.println("** ceil 올림값0 => "+Math.ceil(20.0));
		System.out.println("** ceil 올림값1 => "+Math.ceil(20.123));
		System.out.println("** ceil 올림값2 => "+Math.ceil(20.678));
		// floor : 작거나 같은 가장 작은 정수
		...
		// => Wrapper 객체와 기초 자료형 사이의 변환을 자동으로 수행
		Integer wrapI = a;  // 자동 형변환됨
